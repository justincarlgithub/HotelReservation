      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal" onclick="myFunction1()"  >Proceed to Booking</button>
          </div>
        </div>
      </div>
    </div> 
             ...
             <hr>
                <div class="p-1">
                  ...
                  <div class="row">
                    ...
                    <hr>
                    <div class="row">
                    <h3 class="justify-content-start col-md-8"><b>Total</b> 
                    
                      <a class="justify-content-end fw-bold col-md-4">&#8369;</a><a class="justify-content-end fw-bold" id="total"></a> </h3>
                  </div>
                  
                  <form action="{{url ('reservation/update-booking/'.$room->slug)}}" method="POST">
                    @csrf
                    @method("PUT")
                      <input type="hidden" value={{ $room->id}} name="room_id"> 
                      <input type="hidden" value={{ $room->price}} name="price" id="price"> 
                      <input type="hidden"  name="days" id="days" > 
                      <input type="text"  name="payme1" id="payme1" > 
                    <div class="form-row">
                        <div class="control-group col-sm-6">
                           
                        
                            <input type="text" name="check_in" class="form-control" id="checkin" />
                            <input type="hidden" name="status"  id="staus" value="0"/> 
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group col-sm-6">
                            
                            <input type="text" name="check_out" class="form-control" id="checkout"/>
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
...
var out_date = new Date(document.getElementById('check_out').value);
  ...
  document.getElementById('payme1').value = days_difference * payment; 
